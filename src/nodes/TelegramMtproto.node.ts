  ...
  description: INodeTypeDescription = {
    ...
    properties: [
      ...
      },
      {
        ...
        description:
          "Whether to group chats by their Telegram folders (Dialog Filters)",
      },
      ...
      // USER OPS
      {
        ...
        options: [
          { name: "Get My Profile", value: "getMe", action: "Get My Profile" },
          {
            ...
            value: "getFullUser",
            description:
              "Get detailed information about a user including bio and common chats",
...

      {
        ...
        description:
          "Username (@channel), Invite Link (t.me/...), or numeric ID",
      },
      {
      ...
      },
      {
        ...
        description:
          "If true, forwards to your Saved Messages instead of target chat",
      },
      ...
      },
      {
        ...
        description:
          "Filter by specific media types. Leave empty to allow all media.",
      },
      ...
      },
      {
        ...
        description:
          "Whether to disable the link preview for URLs in the message",
      },
      ...
      },
      {
        ...
        description:
          "Optional formatting entities for the caption (e.g., bold, italic, links)",
      },
      {
      ...
      },
      {
        ...
        description:
          "If true, copies to your Saved Messages instead of target chat",
      },
      {
        displayName: "Target Chat",
        name: "targetChatId",
...

      {
        ...
        description:
          "Maximum ID of message to delete. 0 to delete all messages.",
      },
      // --- POLL PROPERTIES ---
      {
...

      {
        ...
        description:
          "If true, no one can see who voted for what. Required for Channels.",
      },

      {
        ...
        description:
          "The 0-based index of the correct answer (e.g., 0 for the first option)",
      },

      {
        ...
        description:
          "If true, gets your own profile photo without requiring userId",
      },
      ...
      },
      {
        ...
        description:
          "Maximum number of members to retrieve (leave empty to get all)",
      },
      {
      ...
      },
      {
        ...
        description:
          "If enabled, remove admins from the results (overrides Filter Admin Participants)",
      },
      {
        ...
        description:
          "If enabled, remove bots from the results (overrides Filter Bot Participants)",
      },
      {
      ...
      },
      {
        ...
        placeholder: "@username or 123456789",
        description:
          "The username or numeric ID of the user to add to the channel/group",
      },
      {
        ...
        placeholder: "@username or 123456789",
        description:
          "The username or numeric ID of the user to remove from the channel/group",
      },

      {
        ...
        placeholder: "@username or 123456789",
        description:
          "The username or numeric ID of the user to ban from the channel/group",
      },
      {
...

      {
        ...
        placeholder: "@username or 123456789",
        description:
          "The username or numeric ID of the user to unban from the channel/group",
      },

      {
        ...
        placeholder: "@username or 123456789",
        description:
          "The username or numeric ID of the user to promote to admin",
      },
      {
      ...
      },
      {
        ...
        description:
          "Whether the admin can change chat title, photo, and other settings",
      },
      {
      ...
      },
      {
        ...
        description:
          "Whether the admin can add new admins with the same rights",
      },
      {
      ...
      },
      {
        ...
        description:
          "If true, sends to your Saved Messages instead of target chat",
      },
      {
